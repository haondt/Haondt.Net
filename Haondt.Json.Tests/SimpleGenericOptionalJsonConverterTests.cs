...
{
    public class SimpleGenericOptionalData
    {
        public required List<Optional<List<string>>> Strings { get; set; }
    }

    public class SimpleGenericOptionalJsonConverterTests
    {
        ...
        public SimpleGenericOptionalJsonConverterTests()
        {
            ...
            _serializerSettings.Converters.Add(new SimpleGenericOptionalJsonConverter());
        }
        ...
        [Fact]
        public void WillDeserializeEmptyNestedOptional()
        {
            var serialized = JsonConvert.DeserializeObject<Optional<Optional<int>>>(_json2, _serializerSettings);
            serialized.HasValue.Should().BeFalse();
        }

        [Fact]
        public void WillDeserializeNestedOptional()
        {
            var serialized = JsonConvert.DeserializeObject<Optional<Optional<int>>>(_json3, _serializerSettings);
            serialized.Value.Value.Should().Be(_optional3.Value);
        }
    }
}
